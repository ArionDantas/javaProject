        ...
        <div class="container bg-light ">
            ...
            <form action="professor" method="POST">
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input type="text" class="form-control" id="area" placeholder="Enter area" name="txtArea" required> 
                </div>
                <div class="mb-3 mt-3">
                    <label for="txtEmail" class="form-label">E-mail:</label>
                    <input type="text" class="form-control" id="email" placeholder="Enter email" name="txtEmail" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="formacao" placeholder="Enter formação" name="txtFormacao" required>
                </div>
                <div class="mb-3">
